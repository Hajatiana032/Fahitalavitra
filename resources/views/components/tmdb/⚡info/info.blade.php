                ...
                <div class="grid grid-cols-12 gap-5">
                    <div class="col-span-4">
                        <img src="https://image.tmdb.org/t/p/w500/{{ $movie['poster_path'] }}"
                            alt="{{ $movie['title'] }}" class="rounded-2xl">
                    </div>
                    <div class="col-span-8">
                        ...
                        <p class="mt-5">Date de sortie:
                            <span
                                class="badge badge-soft badge-success">{{ \Carbon\Carbon::parse($movie['release_date'])->format('d-M-Y') }}</span>
                        ...
                        <div class="mt-3" x-data="{ show: false }">
                            @if (!empty($videos))
                                <button type="button" class="btn btn-soft btn-success" aria-haspopup="dialog"
                                    aria-expanded="false" aria-controls="basic-modal" data-overlay="#basic-modal"
                            ...
                            <div class="overlay modal overlay-open:opacity-100
                                 ...
                                 hidden"
                                role="dialog" tabindex="-1" x-ref="modal">
                                <template x-if="show">
